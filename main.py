...
if __name__ =='__main__':
    ...
    train_dataset = SpectraGraphDataset(data_source='dataset_dummy/holdout_hcd.hdf5',label_type='scarce')
    val_dataset = SpectraGraphDataset(data_source='dataset_dummy/holdout_hcd.hdf5',label_type='scarce')
    test_dataset = SpectraGraphDataset(data_source='dataset_dummy/holdout_hcd.hdf5',label_type='scarce')
    BATCH_SIZE = 32
