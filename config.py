...
def load_args():
    ...
    parser.add_argument('--root_train', type=str, default='dataset/train_hcd_prec')
    parser.add_argument('--root_val', type=str, default='dataset/val_hcd_prec')
    parser.add_argument('--root_test', type=str, default='dataset/holdout_hcd_prec')
