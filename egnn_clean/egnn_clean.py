...
# taken from https://github.com/vgsatorras/egnn (E(n) Equivariant Graph Neural Networks paper)
...
#could be replaced by PyG torch_geometric.utils  scatter (agg = scatter(edge_attr,row,dim=0,dim_size=x.size(0),reduce="sum")
